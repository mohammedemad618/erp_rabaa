...
export function OcrConsole({ dataset }: OcrConsoleProps) {
  ...
  return (
    <ErpPageLayout>
      <ErpPageHeader title={tOcr("title")} description={tOcr("subtitle")} />
      ...
      >
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-[1.2fr_0.9fr_1.2fr]">
      ...
      <ErpKpiGrid>
        <article className="surface-card p-4">
          ...
          <p className="mt-2 text-sm font-semibold text-finance">{datasetAverageConfidence}%</p>
        </article>
        <article className="surface-card p-4">
          <p className="text-xs text-muted-foreground">{tOcr("top.documents")}</p>
          <p className="mt-2 text-sm font-semibold text-finance">{sectionDocuments.length}</p>
        </article>
        <article className="surface-card p-4">
          <p className="text-xs text-muted-foreground">{tOcr("top.lowConfidenceDocs")}</p>
          <p className="mt-2 text-sm font-semibold text-finance">{docsWithLowConfidence}</p>
        </article>
        <article className="surface-card p-4">
          <p className="text-xs text-muted-foreground">{tOcr("top.unresolvedFields")}</p>
          <p className="mt-2 text-sm font-semibold text-finance">{unresolved.length}</p>
        </article>
      </ErpKpiGrid>

      <ErpMainSplit
        className="min-[1400px]:grid-cols-[1.2fr_1fr]"
        primary={
          <OcrDocumentViewer
      ...
      {activeSection === "quality" ? (
        <ErpSection
          ...
          title={tOcr("quality.title")}
          description={tOcr("quality.subtitle")}
        >
